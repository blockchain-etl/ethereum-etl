...
Export ERC20 and ERC721 transfers ([Schema](docs/schema.md#token_approvalscsv), [Reference](docs/commands.md##export_token_approvals)):
...
Stream blocks, transactions, logs, token_transfers, token_approvals continually to console ([Reference](docs/commands.md#stream)):
