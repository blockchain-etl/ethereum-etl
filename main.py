...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--start-block-index', type=int, help='start block index')
    parser.add_argument('-e', '--end-block-index', type=int, help='end block index')
    ...
    parser.add_argument('-et', '--entity-types', type=str, default=','.join(ENTITY_TYPES_DEFAULT),
                        help='The list of entity types to export')
    args = parser.parse_args()

    start_block = natural_number(args.start_block_index)
    end_block = natural_number(args.end_block_index)
